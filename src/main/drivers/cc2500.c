...
uint8_t cc2500_writeFifo(uint8_t *dpbuffer, uint8_t len)
{
    ...
    ret = rxSpiWriteCommandMulti(CC2500_3F_TXFIFO | CC2500_WRITE_BURST , dpbuffer, len);	
...
uint8_t cc2500_WriteRegisterMulti(uint8_t address, uint8_t *data, uint8_t length)
{
