...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
   ...
   // DEF_TIM(TIM16, CH1, PA6,  TIM_USE_MOTOR,             1), // PWM7 - PA6  - TIM3_CH1, TIM8_BKIN, TIM1_BKIN, *TIM16_CH1
    //DEF_TIM(TIM17, CH1, PA7,  TIM_USE_MOTOR,             1), // PWM9 - PA7  - TIM3_CH2, *TIM17_CH1, TIM1_CH1N, TIM8_CH1
